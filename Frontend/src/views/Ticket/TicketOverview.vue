...
<template>
  <div class="fixHeight flex items-center justify-center">
    ...
    <div v-if="closeTicketOpen" class="fixed top-0 left-0 fixHeight w-screen bg-black bg-opacity-25 z-30 flex items-center justify-center">
      <form @submit.prevent="submitCloseTicket" class="bg-white p-6 rounded-3xl flex flex-col">
        <h1>Close Ticket</h1>
        <hr class="my-2">
        ...
        <div class="flex justify-center">
          ...
          <input @click="closeCloseTicket" class="bg-gray-200 hover:bg-gray-300 cursor-pointer p-2 rounded-lg ml-1 w-full" type="button" value="Cancel">
        </div>
